...
//       <div className="absolute inset-0 bg-gradient-to-br from-[#F3F4F5] via-[#FF9408]/70 to-[#FF9408] animate-gradient-flow" />

//       {/* Glow Orbs */}
//       <div className="absolute top-20 left-10 w-40 h-40 rounded-full bg-[#FF9408]/30 blur-3xl animate-pulse" />
//       <div className="absolute bottom-32 right-16 w-56 h-56 rounded-full bg-[#F3F4F5]/20 blur-2xl animate-pulse delay-1000" />
...
//             <span className="text-gradient">Nandini Khandelwal</span>
//           </h1>
...
//             Passionate robotics and AI engineer with a focus on autonomous systems, computer vision, 
//             and intelligent automation. Blending creativity and technical depth to build 
//             human-centric tech with real-world impact.
//           </p>
...
//             <Button 
//               size="lg" 
//               className="bg-gradient-hero hover:shadow-[0_0_25px_rgba(255,148,8,0.6)] hover:scale-105 transition-transform px-8 py-6 text-lg font-semibold"
...
//               variant="outline" 
//               size="lg"
//               className="border-2 border-tangerine text-tangerine hover:bg-tangerine hover:text-white hover:shadow-[0_0_25px_rgba(255,148,8,0.6)] px-8 py-6 text-lg font-semibold"
...
//                 className="p-3 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 hover:bg-tangerine hover:shadow-[0_0_20px_rgba(255,148,8,0.6)] hover:scale-110 transition-all duration-300 hover-wiggle group"
//                 aria-label={label}
//               >
...
//           <img 
//             src="images/gallery/isro.JPG" 
//             alt="Nandini working on robotics" 
//             className="rounded-2xl shadow-lg max-w-sm md:max-w-md object-cover hover:shadow-[0_0_30px_rgba(255,148,8,0.5)] transition-all duration-500"
//           />
//         </div>
//       </div>
...
//     <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
//       {/* Background Gradient */}
//       <div className="absolute inset-0 bg-gradient-to-br from-[#95122C] via-[#70132F] to-[#100C08] animate-gradient-flow" />

//       {/* Glow Orbs */}
//       <div className="absolute top-16 left-10 w-44 h-44 rounded-full bg-[#f7838d]/40 blur-3xl animate-pulse" />
//       <div className="absolute bottom-32 right-16 w-56 h-56 rounded-full bg-[#f7838d]/20 blur-2xl animate-pulse delay-1000" />
//       <div className="absolute top-1/3 right-1/4 w-32 h-32 rounded-full bg-[#f7838d]/30 blur-2xl animate-pulse" />
...
//           <p className="text-lg md:text-xl text-black/70 mb-12 max-w-xl leading-relaxed hover:text-[#f7838d] transition-colors">
...
//                 target="_blank"
//                 rel="noopener noreferrer"
//                 className="p-3 rounded-full bg-white/10 border border-black/20 hover:bg-[#f7838d] hover:shadow-[0_0_20px_rgba(247,131,141,0.6)] hover:scale-110 transition-all duration-300"
//                 aria-label={label}
//               >
